...
import {getBrandApi, getBannerApi,getFreshApi,getRecommandApi,getGoodsApi } from '@/apis/testAPI';
import { useCategoryStore } from '@/store/category';
import { storeToRefs } from 'pinia';

//导入封装的业务函数
import { useBanner } from './composables/useBanner';
import { useRecommand } from './composables/useRecommand';
import { useFresh } from './composables/useFresh'; 
